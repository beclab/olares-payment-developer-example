 ...
 */
export const VcApplicationSchemaReqSchema: GenMessage<VcApplicationSchemaReq, {jsonType: VcApplicationSchemaReqJson}> = /*@__PURE__*/
  messageDesc(file_v1_domain_vc, 0);
 ...
 */
export type VcApplicationSchemaResp = Message<"payment.v1.VcApplicationSchemaResp"> & {
  /**
 ...
 * @generated from message payment.v1.VcApplicationSchemaResp
 */
export type VcApplicationSchemaRespJson = {
  /**
   * credential manifest (arbitrary JSON, wallet consumes byte-shape)
   *
   * @generated from field: google.protobuf.Struct manifest = 1;
 ...
 */
export const VcApplicationSchemaRespSchema: GenMessage<VcApplicationSchemaResp, {jsonType: VcApplicationSchemaRespJson}> = /*@__PURE__*/
  messageDesc(file_v1_domain_vc, 1);
 ...
 */
export type VcRequestReq = Message<"payment.v1.VcRequestReq"> & {
  /**
 ...
 */
export const VcRequestReqSchema: GenMessage<VcRequestReq, {jsonType: VcRequestReqJson}> = /*@__PURE__*/
 ...
 */
export type VcRequestResp = Message<"payment.v1.VcRequestResp"> & {
  /**
 ...
 */
export const VcRequestRespSchema: GenMessage<VcRequestResp, {jsonType: VcRequestRespJson}> = /*@__PURE__*/
  messageDesc(file_v1_domain_vc, 3);
 ...
 */
export type IssuedCredentialView = Message<"payment.v1.IssuedCredentialView"> & {
  /**
 ...
 * @generated from message payment.v1.IssuedCredentialView
 */
export type IssuedCredentialViewJson = {
  /**
   * ∃ issued credential for this (buyer, product)
   *
   * @generated from field: bool found = 1;
 ...
 */
export const IssuedCredentialViewSchema: GenMessage<IssuedCredentialView, {jsonType: IssuedCredentialViewJson}> = /*@__PURE__*/
  messageDesc(file_v1_domain_vc, 4);
